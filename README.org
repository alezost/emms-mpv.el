...
- Another additional feature of =emms-mpv= is saving and restoring track
progress.  By default, if a media file is not fully played, its progress
will be saved and restored the next time you will play this file.  If
you don't need this feature, set =emms-mpv-keep-progress= variable to
nil.
...
#+BEGIN_SRC example
Symbol’s value as variable is void: property
#+END_SRC
